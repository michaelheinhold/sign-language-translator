...
class SignLanguageMNIST(Dataset):
  ...
  Utility for loading Sign Language dataset into PyTorch. Dataset posted on Kaggle in 2017, by an unnamed author with username `tecperson`:
  ...
  def __init__(self,
    ...
    self._samples = np.array(labels, dtype=np.uint8).reshape((-1, 1))
